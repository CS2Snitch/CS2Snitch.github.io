const catalog = [
  {id:'train',title:'The Great Train Robbery',year:1903,genre:'Western / Short',duration:12,rights:'Public domain',rightsBasis:'Published in the U.S. before 1931; Wikimedia Commons marks this exact media file public domain',source:'Wikimedia Commons / Library of Congress source record',mediaUrl:'https://commons.wikimedia.org/wiki/Special:Redirect/file/The_Great_Train_Robbery_1903.webm'},
  {id:'within',title:'Within Our Gates',year:1920,genre:'Drama',duration:77,rights:'Public domain in U.S.',rightsBasis:'Wikimedia Commons marks this exact media file public domain in the United States',source:'Wikimedia Commons; underlying film by Oscar Micheaux',mediaUrl:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Within_Our_Gates_(1920).webm'},
  {id:'earthquake',title:'San Francisco Earthquake and Fire',year:1906,genre:'Documentary / Short',duration:13,rights:'Public domain',rightsBasis:'Library of Congress states the Early Films of San Francisco collection is public domain and free to use/reuse',source:'Library of Congress item 00694425',mediaUrl:'https://tile.loc.gov/storage-services/media/ammem/EarlyFilmsofSanFrancisco/03734.mp4'},
  {id:'kiss',title:'The May Irwin Kiss',year:1896,genre:'Short',duration:1,rights:'Rights record only',rightsBasis:'Underlying U.S. work predates 1931',source:'Media file not yet attached',mediaUrl:''},
...
const channels = [
  {no:'01',name:'Retro TV',desc:'A rotating mix of verified classics',playlist:['train','within','earthquake']},
  {no:'02',name:'Classic Cinema',desc:'Features and silent landmarks',playlist:['within','train']},
  {no:'03',name:'Archive After Dark',desc:'Historic cinema and documentary programming',playlist:['within','earthquake','train']},
  {no:'04',name:'Western Trail',desc:'Frontier shorts and westerns',playlist:['train']},
  {no:'05',name:'Short Subjects',desc:'Newsreels, shorts and curiosities',playlist:['earthquake','train']}
];

const $ = s=>document.querySelector(s); const $$=s=>[...document.querySelectorAll(s)];
function item(id){return catalog.find(x=>x.id===id)}
function posterMarkup(m){const playable=!!m.mediaUrl;return `<div class="poster"><span class="year">${m.year}</span><h3>${m.title}</h3><small>${m.genre}</small></div><div class="movie-info"><small>${m.duration} min · ${m.rights}</small><br><span class="badge">${playable?'PLAYABLE · RIGHTS RECORDED':'NOT YET PUBLISHED'}</span></div>`}
